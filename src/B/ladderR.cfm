<cfscript>
	...
	if (structKeyExists(form, "submit") and form.submit eq "Yes"){
		...
		location("finish.cfm#request.qs()#");
	}
	...
	<form method="post" action="ladderR.cfm">
		...
		<div class="audio"><cfloop array="#audio#" index="a"><audio id="#a#" data-player="p_#a#" src="../audio/r/#a#.wav"></audio></cfloop></div>
